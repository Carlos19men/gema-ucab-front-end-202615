...
export async function getGruposDeTrabajo() {
  ...
  const resp = await fetch(`${BASE_URL}/grupos`, {
    method: "GET",
    headers: {
...
export async function getAllWorkersInGroup({
  ...
  const resp = await fetch(`${BASE_URL}/trabajaEnGrupo/${grupoDeTrabajoId}`, {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
...
export async function getAllWorkersInALLGroups() {
  ...
  const resp = await fetch(`${BASE_URL}/trabajaEnGrupo`, {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
...
export async function deleteTecnicoFromGrupo({
  ...
  const resp = await fetch(
    `${BASE_URL}/trabajaEnGrupo/${tecnicoId}/${grupoDeTrabajoId}`,
    {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
...
export async function deleteGrupoDeTrabajo(grupoDeTrabajoId: number) {
  ...
  const resp = await fetch(`${BASE_URL}/grupos/${grupoDeTrabajoId}`, {
    method: "DELETE",
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
...
export async function editGrupoDeTrabajo({
  ...
  const resp = await fetch(`${BASE_URL}/grupos/${id}`, {
    method: "PUT",
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
